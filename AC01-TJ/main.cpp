...
#define AC01  /* AC01 old board RS01 new board */

#if defined(AC01)
  #include <../lib/PrivateLibs/ac01.h>
#elif defined(RS01)
  #include <../libraries/PrivateLibs/rs01.h>
#endif

#include <../lib/PrivateLibs/FormattedMessages.h>
#include <../lib/PrivateLibs/EspReporting.h>
   ...
   // oneWire.deviceReset();
    ...
    for (int iCH = 0; iCH<8; iCH++ ) {
     ...
     if (oneWire.wireReset()) {
        ...
        int keynum;
        if (oneWire.wireSearch(currAddress)) {
          #if defined(RS01)
